 ...
 */
		...
		_class("Ticker", function(fps, useRAF) {
			var _self = this,
				...
				_fps, _req, eventNo, _gap, _nextTime,
			...
			_self.sleep = function() {
				...
				if (!_useRAF || !_cancelAnimFrame) {
					clearTimeout(eventNo);
				} else {
					_cancelAnimFrame(eventNo);
				}
				_req = _emptyFunc;
				eventNo = null;
				if (_self === _ticker) {
	...
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		var _transformProps = ("scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent").split(","),
			...
			_parseSVGOrigin = function(e, local, decoratee, absolute, smoothOrigin) {
				...
				if (absolute && m !== eventNoentity2DMatrix) { //if svgOrigin is being set, we must invert the matrix and determine where the absolute point is, factoring in the current transforms. Otherwise, the svgOrigin would be based on the element's non-transformed position on the canvas.
					a = m[0];
					b = m[1];
					c = m[2];
					d = m[3];
			...
			eventNoentity2DMatrix = [1,0,0,1,0,0],
