...
class TP_instagram {
	 ...
	 *
	 * @since    1.0.0
	 * @param    string    $usereventNo 	Instagram User id (not name)
	 */
	public function get_public_photos($search_usereventNo){
		//call the API and decode the response
		$url = "https://api.instagram.com/v1/users/".$search_usereventNo."/media/recent?access_token=".$this->api_key."&clienteventNo=".$search_usereventNo;
