                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
														...
														<p><span style="font-weight:bold;font-size:16px">Service order:</span> '.$orderservices.'</p>
														<p><span style="font-weight:bold;font-size:16px">Order budget:</span> '.$orderbudget.'</p>
														<p><span style="font-weight:bold;font-size:16px">Order timeframe:</span> '.$ordertimeframe.'</p>
														<p><span style="font-weight:bold;font-size:16px">Files attached:</span> '.$order_upload.' </p>
