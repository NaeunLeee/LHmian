        ...
        <div class="row sec-padding">
          <div class="col-xs-12 nopadding">
            <div class="sec-title-container text-center">
              <h2 class="uppercase font-weight-7 less-mar-1">Awesome lhmian<span class="text-gyellow">.</span></h2>
              <h6 class=" font-weight-4 nopadding subtitle-gray">자연에 예술 조경을 더해 명품 대단지를 완성하다</h6>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 40px"> <br/>
            ...
            <div class="ce4-feature-box-19 margin-bottom">
              <h5 class="title font-weight-5 nopadding title">조명폰드</h5>
              <div class="title-line"></div>
              <br/>
              <p>주위를 감싸는 수경시설과 <br>그늘아래에서 여유를 즐기는 <br>감성 공간</p>
            </div>
            <!--end feature box-->
          ...
          <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: 40px"> <br/>
            <div class="ce4-feature-box-19 margin-bottom">
              ...
              <div class="title-line"></div>
              <br/>
              <p>구릉형 지형을 따라 걷고 사색하며 <br>눈앞에 펼쳐진 경관을 <br>감상할 수 있는 산책로</p>
            </div>
            <!--end feature box-->
            ...
            <div class="col-divider-margin-6"></div>
            <div class="ce4-feature-box-19 margin-bottom">
              <h5 class="title font-weight-5 nopadding title">주민운동시설</h5>
              <div class="title-line"></div>
              <br/>
              <p>가족의 건전한 여가 활동과 <br>삶의 활기를 찾는 <br>운동공간</p>
            </div>
            <!--end feature box--> 
