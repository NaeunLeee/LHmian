...
<div class="rev_slider_wrapper" id="rev_wrapper">
	...
	<div id="rev_slider" class="rev_slider" data-version="5.0">
		<ul>
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					data-voffset="['50','120','30','10']" data-width="none"
					...
					data-start="1000" data-responsive_offset="off" data-responsive="on"
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평형도세대별1.png"
						alt="" data-ww="['600px','302px','450','290']"
						data-hh="['600px','260px','387','249']" data-no-retina
						style="width: 250px;">
				</div> <!-- LAYER NR. 2 -->
				<div class="tp-caption ce3-text-1 tp-resizeme"
					data-x="['left','left','left','left']"
					data-hoffset="['710','395','80','80']"
					data-y="['top','top','top','top']"
					data-voffset="['210','180','180','120']" data-width="none"
					data-height="none" data-whitespace="nowrap"
					data-transform_idle="o:1;"
					...
					style="z-index: 5; white-space: nowrap;"></div> <!-- LAYER NR. 3 -->
				<div class="tp-caption roboto bold text-dark tp-resizeme"
					data-x="['left','left','left','left']"
					data-hoffset="['750','450','100','100']"
					data-y="['top','top','top','top']"
					data-voffset="['180','180','420','220']"
					data-width="['auto','auto','auto','auto']"
					data-height="['auto','auto','auto','auto']"
					data-transform_idle="o:1;" data-fontsize="['60','60','40','30']"
					...
					data-splitin="none" data-splitout="none"
					data-responsive_offset="on"
					style="z-index: 5; white-space: nowrap; font-size: 45px; line-height: 30px;">74㎡A
				</div> <!-- LAYER NR. 3 -->
				<div class="tp-caption br-text-3 tp-resizeme"
					data-x="['left','left','left','left']"
					data-hoffset="['750','450','100','100']"
					data-y="['top','top','top','top']"
					data-voffset="['300','300','580','380']" data-width="none"
					data-height="none" data-whitespace="nowrap"
					data-transform_idle="o:1;" data-fontsize="['15','15','15','13']"
					data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:1500;e:Power3.easeInOut;"
					data-transform_out="opacity:0;s:1000;s:1000;"
					data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-start="2500"
					data-splitin="none" data-splitout="none"
					data-responsive_offset="on"
				...
				<div class="tp-caption sbut2" data-x="['left','left','left','left']"
					data-hoffset="['750','450','100','100']"
					data-y="['top','top','top','top']"
					data-voffset="['470','450','680','480']" data-speed="800"
					data-start="3000"
					data-transform_in="y:bottom;s:1500;e:Power3.easeOut;"
					data-transform_out="opacity:0;s:3000;e:Power4.easeIn;s:3000;e:Power4.easeIn;"
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					data-hoffset="['10','40','0','0']"
					data-y="['top','top','top','top']"
					data-voffset="['100','120','30','10']" data-width="none"
					data-height="none" data-whitespace="nowrap"
					data-transform_idle="o:1;"
					data-transform_in="y:bottom;s:1500;e:Power3.easeOut;"
					data-transform_out="opacity:0;s:3000;e:Power4.easeIn;s:3000;e:Power4.easeIn;"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도74.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div> <!-- LAYER NR. 3 -->
				<div class="tp-caption" data-x="['right','right','center','center']"
					data-hoffset="['10','40','100','100']"
					data-y="['top','top','top','top']"
					data-voffset="['100','120','30','10']" data-width="none"
					data-height="none" data-whitespace="nowrap"
					data-transform_idle="o:1;"
					data-transform_in="y:bottom;s:1500;e:Power3.easeOut;"
					data-transform_out="opacity:0;s:3000;e:Power4.easeIn;s:3000;e:Power4.easeIn;"
					data-start="1500" data-responsive_offset="off" data-responsive="on"
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도74-1.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div>
		...
		<div class="tp-leftarrow tparrows   noSwipe"
			style="top: 50%; transform: matrix(1, 0, 0, 1, 20, -20); left: 0px; visibility: hidden; opacity: 0;"></div>
		<div class="tp-rightarrow tparrows   noSwipe"
			style="top: 50%; transform: matrix(1, 0, 0, 1, -60, -20); left: 100%; visibility: hidden; opacity: 0;"></div>
	</div>
		...
		<ul>
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도86.png"
						alt="" data-ww="['600px','302px','450','290']"
						data-hh="['600px','260px','387','249']" data-no-retina
						style="width: 250px;">
				</div> <!-- LAYER NR. 2 -->
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도86-1.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div> <!-- LAYER NR. 3 -->
				<div class="tp-caption" data-x="['right','right','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도86-2.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div>
...
<!-- START REVOLUTION SLIDER 5.0 -->
<!-- 92m 시작 -->
<div class="rev_slider_wrapper" id="rev_wrapper2">
	<!-- START REVOLUTION SLIDER 5.0 auto mode -->
	<div id="rev_slider2" class="rev_slider" data-version="5.0">
		<ul>
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도92.png"
						alt="" data-ww="['600px','302px','450','290']"
						data-hh="['600px','260px','387','249']" data-no-retina
						style="width: 250px;">
				</div> <!-- LAYER NR. 2 -->
				...
				<div class="tp-caption roboto bold text-dark tp-resizeme"
					...
					data-splitin="none" data-splitout="none"
					data-responsive_offset="on"
					style="z-index: 5; white-space: nowrap; font-size: 45px; line-height: 30px;">92㎡A
				</div> <!-- LAYER NR. 3 -->
				<div class="tp-caption br-text-3 tp-resizeme"
					data-x="['left','left','left','left']"
					data-hoffset="['750','450','100','100']"
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도92-1.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div> <!-- LAYER NR. 3 -->
				<div class="tp-caption" data-x="['right','right','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도92-2.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div>
...
<!-- START REVOLUTION SLIDER 5.0 -->
<!-- 104m 시작 -->
<div class="rev_slider_wrapper" id="rev_wrapper3">
	<!-- START REVOLUTION SLIDER 5.0 auto mode -->
	<div id="rev_slider3" class="rev_slider" data-version="5.0">
		<ul>
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도104.png"
						alt="" data-ww="['600px','302px','450','290']"
						data-hh="['600px','260px','387','249']" data-no-retina
						style="width: 250px;">
				</div> <!-- LAYER NR. 2 -->
			...
			<li data-transition="fade">
				...
				<div class="tp-caption" data-x="['left','left','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도104-1.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div> <!-- LAYER NR. 3 -->
				<div class="tp-caption" data-x="['right','right','center','center']"
					...
					style="z-index: 5; text-transform: left;">
					<img
						src="${pageContext.request.contextPath }/resources/images/sliders/평면도104-2.png"
						class="img-responsive" alt=""
						data-ww="['580px','302px','450','290']"
						data-hh="['480px','260px','387','249']" data-no-retina>
				</div>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/cubeportfolio/lightbox-gallery.js"></script>
...
/* 		if(tpj("#rev_slider").revolution == undefined){
		...
		revapi6 = tpj("#rev_slider2").show().revolution({
			sliderType:"standard",
			jsFileLocation:"js/revolution-slider/js/",
			sliderLayout:"auto",
			dottedOverlay:"none",
		...
		revapi7 = tpj("#rev_slider3").show().revolution({
			sliderType:"standard",
			jsFileLocation:"js/revolution-slider/js/",
			sliderLayout:"auto",
			dottedOverlay:"none",
