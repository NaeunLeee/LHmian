		...
		<div class="row">
			...
			<div class="text-box white padding-4 col-7">
					<div class="text-box">
						...
						<c:if test="${info.oiUpdate != null}">
						 | 최종수정 : <fmt:formatDate value="${info.oiUpdate}" pattern="yy-MM-dd" />
						 </c:if></h6>
					</div>
					</div>
...
<%-- 						<div class="text-box padding-2 border" style="margin-bottom: 20px; ">
					...
					<div class="text-box padding-2 void" style="margin-bottom: 200px; ">${info.oiContent}</div>
					...
					<div class="divider" style="margin-bottom: 15px;"></div>
						...
						<div class="col-md-10">
							<a style="color: blue;" href="opeInfoDownload?oiFileid=${info.oiFileid}">${info.oiFilename}</a>
						</div>
					</c:if>
