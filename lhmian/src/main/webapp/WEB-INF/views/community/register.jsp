			...
			<div class="row">
				<div class="col-xs-12 nopadding">
					<div class="sec-title-container-padding-topbottom text-center">
						...
						<div class="clearfix"></div>
						<p class="by-sub-title">수정할 내용을 입력해주세요.</p>
					</div>
				</div>
				<div class="clearfix"></div>
			</div>
		...
		<div class="container" align="center">
			<div class="text-box white padding-4 col-7">
				<form role="form" id="frm" name="frm" action="insertComm" method="post">
					<div>
						<input type="text" id="commTitle" name="commTitle" class="form-control" placeholder="제목을 입력하세요.">
						<hr>
					</div>
					<div>
						<textarea class="form-control" id="commContent" name="commContent"></textarea>
					</div>
					<br><br>
					<div>
						<input type="hidden" id="id" name="id" value="${name}"> 
						<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
						<button type="button" class="btn btn-gyellow" id="btnRegister">등록</button>
