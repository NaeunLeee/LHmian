...
<button class="btn btn-border light" type="button" onclick="location.href='../admin/admNoticeInsert'" style="float:right; margin-right:20px; padding: 4px 13px;">글등록</button>
<br>
