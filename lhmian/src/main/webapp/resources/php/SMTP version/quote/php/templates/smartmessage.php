                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
														...
														<p><span style="font-weight:bold;font-size:16px">Sender website:</span> '.$senderwebsite.'</p>
														<p><span style="font-weight:bold;font-size:16px">Services required:</span> '.$services.'</p>
														<p><span style="font-weight:bold;font-size:16px">Project budget:</span> '.$budget.'</p>
														<p><span style="font-weight:bold;font-size:16px">Project timeframe:</span> '.$timeframe.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px;">Quotation details below:</span> </p>
                                                        <p style="margin-bottom:0;"> '.nl2br($details).' </p>
