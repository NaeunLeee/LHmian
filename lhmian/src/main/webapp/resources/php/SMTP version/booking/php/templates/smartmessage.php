                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Guest name:</span> '.$guestname.'</p>
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Adult guests:</span> '.$adults.'</p>
														<p><span style="font-weight:bold;font-size:16px">Child guests:</span> '.$children.'</p>
														<p><span style="font-weight:bold;font-size:16px">Check-in date:</span> '.$checkin.'</p>
														<p><span style="font-weight:bold;font-size:16px">Check-out date:</span> '.$checkout.'</p>
                                                        <p><span style="font-weight:bold;font-size:16px;">Question or comment below:</span> </p>
